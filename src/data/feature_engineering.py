...
def load_data(data_path:str)->pd.DataFrame :
    ...
    return datafrm
def feature_engineering(df:pd.DataFrame,data_path_houses:str)->pd.DataFrame:
    ...
    app_df = load_data(data_path_houses)
...
def save_data(final_df:pd.DataFrame,data_path:str)->None:
    data_path = os.path.join(data_path,'featured_data')
    os.makedirs(data_path,exist_ok=True)
    try:
        final_data_path = os.path.join(data_path,'preprocessed_dataset_v2.csv')
